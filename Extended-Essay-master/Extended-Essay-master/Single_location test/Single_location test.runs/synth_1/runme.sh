...
HD_PWD='D:/Files/Vivado/EE/EE-GITHUB/Extended-Essay/Extended-Essay-master/Extended-Essay-master/Single_location test/Single_location test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compare_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source compare_test.tcl
