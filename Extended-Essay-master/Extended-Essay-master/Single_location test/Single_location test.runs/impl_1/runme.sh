...
HD_PWD='D:/Files/Vivado/EE/EE-GITHUB/Extended-Essay/Extended-Essay-master/Extended-Essay-master/Single_location test/Single_location test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log compare_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source compare_test.tcl -notrace
