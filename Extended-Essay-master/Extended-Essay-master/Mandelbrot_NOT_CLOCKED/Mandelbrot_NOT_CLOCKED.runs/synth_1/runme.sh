...
HD_PWD='D:/Files/Vivado/EE/Extended-Essay-master/Extended-Essay-master/Mandelbrot_NOT_CLOCKED/Mandelbrot_NOT_CLOCKED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Location.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Single_Location.tcl
